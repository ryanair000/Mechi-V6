-- Jenga is a shared Supabase project. Mechi tags every auth signup with
-- raw_user_meta_data.app = 'mechi'. Keep legacy app bootstrap triggers from
-- provisioning unrelated records for Mechi users while preserving their
-- existing behavior for every other app.
